(function (credentials, helpers) {
  ...
  exports.methodA1 = function (params) {
    var url = 'http://localhost/w3s.html' + credentials.apiKey;
    return $.ajax({url: url});
  };
  
  exports.methodA1User = function(params) {
    var url = 'http://localhost/w3s.html' + params.UserId;
...
//  };
  ...
  exports.authenticatedMethodA1 = function(params){
    ...
    var completeUrl = 'http://localhost/w3s.html?' +  $.param(urlParams);
    return $.ajax({
      url: completeUrl,
      type: 'GET',
      dataType: 'json'})
